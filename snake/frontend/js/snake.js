    ...
    */
    return function(config) {
        ...
        function submitScore(){
            ...
            const url='http://' + ip + ':5000/submit_score?new_score=' + highScore + "&username=" + username; 
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "<a href='https://github.com/patorjk/JavaScript-Snake' class='snake-link'>source code</a> - <a href='https://www.youtube.com/channel/UCpcCLm9y6CsjHUrCvJHYHUA' class='snake-link'>pats youtube</a> - <a href='/high_score.html' class='snake-link'>leaderboard</a>";
        ...
        function createTryAgainElement() {
            return createGameEndElement("You died :( Submitting score!", "sbTryAgain", "snake-try-again-dialog");
        }
